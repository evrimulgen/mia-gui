...
public class ComputationResource {
    ...
    @Timed
    public ResponseEntity<Computation> createComputation(@RequestBody Computation computation) throws URISyntaxException {
    ...
    @RequestMapping(value = "/computations",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Computation> updateComputation(@RequestBody Computation computation) throws URISyntaxException {
    ...
    public ResponseEntity<Computation> getComputation(@PathVariable Long id) {
        ...
        Computation computation = computationRepository.findOneWithEagerRelationships(id);
